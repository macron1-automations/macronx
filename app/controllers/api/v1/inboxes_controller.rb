  ...
  module V1
    class InboxesController < BaseController
      ...
      resource_description do
        short "Inbox entries"
        description "Create and retrieve inbox records. Name is optional (auto-generated if omitted). File attachments require multipart/form-data."
        formats [ "json" ]
      end
      ...
      param :inbox, Hash, required: true do
        ...
        param :tag_id,   :number, desc: "ID of an existing tag to assign"
      ...
      def inbox_params
        params.require(:inbox).permit(:name, :source, :summary, :body, :tag_id, payload: {}, metadata: {}, attachments: [])
      end
